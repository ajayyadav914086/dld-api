            ...
            if (error) {
              ...
              DataEntry.findOne({ _id: mongoose.Types.ObjectId(req.body.postId) }, (error: any, data: any) => {
                if (error) {
                  ...
                  var dldId = '<p style="margin-left:-1px; text-align:center"><span style="font-size:14px"><strong>' + data.dldId + '</strong></span></p><br/>';
                  var importantPoints = '<head><meta name="viewport" content="width=device-width, initial-scale=1.0"><style>*{margin-right:0px!important}p{margin-top:0px;margin-bottom:0px;overflow-y: hidden;}ol{margin:0px;}body{padding: 0px 12px;}</style></head><body></body><p style="margin-left:-1px"><span id="test" style="font-size:14px"><strong>Important Point:&nbsp;&nbsp;</strong><span style="font-family:Calibri,sans-serif"><span style="color:#808000">' + data.importantPoints + '</span></span></span></p>';
                  var importantPointsHindi = '<p style="margin-left:-1px"><span style="font-size:14px"><strong>महत्वपूर्ण बिंदु:&nbsp;&nbsp;</strong><span style="font-family:Calibri,sans-serif"><span style="color:#808000">' + data.importantPointsHindi + '</span></span></span></p>';
                  var importantPointsMarathi = '<p style="margin-left:-1px"><span style="font-size:14px"><strong>महत्त्वाचा मुद्दा:&nbsp;&nbsp;</strong><span style="font-family:Calibri,sans-serif"><span style="color:#808000">' + data.importantPointsMarathi + '</span></span></span></p>';
                  var importantPointsGujrati = '<p style="margin-left:-1px"><span style="font-size:14px"><strong>મહત્વનો મુદ્દો:&nbsp;&nbsp;</strong><span style="font-family:Calibri,sans-serif"><span style="color:#808000">' + data.importantPointsGujarati + '</span></span></span></p>';
                  var decidedDate = '<p style="margin-left:-1px; text-align:center"><span style="font-size:14px"><strong>DECIDED ON: ' + dateformat(new Date(data.decidedDate), "dd-mm-yyyy"); + '</strong></span></p><br/><br/>';
                  var soi = '<p style="margin-left:-1px; text-align:center"><span style="font-size:18px"><strong>SUPREME COURT OF INDIA</strong></span></p><br/>';
                  var vs = '<p style="margin-left:-1px; text-align:center"><span style="font-size:14px"><strong>VS</strong></span></p><br/>';
                  var appelentName = '<p style="margin-left:-1px; text-align:center"><span style="font-size:14px"><strong>' + data.appelentName + '-APPELLANT</strong></span></p><br/>';
                  var judges = '<p style="margin-left:-1px; text-align:center"><span style="font-size:14px"><strong>( Before : ' + data.judges + ', JJ. )</strong></span></p><br/>';
                  var headNote = '<p style="margin-left:-1px"><span style="font-size:14px"><strong><span style="color:#00000a; font-family:Calibri, sans-serif">Head Point:&nbsp;</span></strong><span style="font-family:Calibri,sans-serif"><span style="color:#ff0000">' + data.headNote + '</span></span></span></p>';
                  var headNoteHindi = '<p style="margin-left:-1px"><span style="font-size:14px"><strong><span style="color:#00000a; font-family:Calibri, sans-serif">शीर्ष टिप्पणी:&nbsp;</span></strong><span style="font-family:Calibri,sans-serif"><span style="color:#ff0000">' + data.headNoteHindi + '</span></span></span></p>';
                  var headNoteMarathi = '<p style="margin-left:-1px"><span style="font-size:14px"><strong><span style="color:#00000a; font-family:Calibri, sans-serif">मुख्य टीप:&nbsp;</span></strong><span style="font-family:Calibri,sans-serif"><span style="color:#ff0000">' + data.headNoteMarathi + '</span></span></span></p>';
                  var headNoteGujrati = '<p style="margin-left:-1px"><span style="font-size:14px"><strong><span style="color:#00000a; font-family:Calibri, sans-serif">મુખ્ય નોંધ:&nbsp;</span></strong><span style="font-family:Calibri,sans-serif"><span style="color:#ff0000">' + data.headNoteGujarati + '</span></span></span></p>';
                  var respondentName = '<p style="margin-left:-1px; text-align:center"><span style="font-size:14px"><strong>' + data.respondentName + '-RESPONDENT</strong></span></p><br/>';
                  var result = '<p style="margin-left:-1px"><strong><span style="font-size:14px"><span style="font-family:Calibri,sans-serif"><span style="color:#00000a">Result:&nbsp;</span></span></span></strong><span style="font-size:14px"><span style="font-family:Calibri,sans-serif"><span style="color:#00000a">' + data.result + '</span></span></span></p>';
                  var resultHindi = '<p style="margin-left:-1px"><strong><span style="font-size:14px"><span style="font-family:Calibri,sans-serif"><span style="color:#00000a">परिणाम:&nbsp;</span></span></span></strong><span style="font-size:14px"><span style="font-family:Calibri,sans-serif"><span style="color:#00000a">' + data.resultHindi + '</span></span></span></p>';
                  var resultMarathi = '<p style="margin-left:-1px"><strong><span style="font-size:14px"><span style="font-family:Calibri,sans-serif"><span style="color:#00000a">परिणाम:&nbsp;</span></span></span></strong><span style="font-size:14px"><span style="font-family:Calibri,sans-serif"><span style="color:#00000a">' + data.resultMarathi + '</span></span></span></p>';
                  var resultGujrati = '<p style="margin-left:-1px"><strong><span style="font-size:14px"><span style="font-family:Calibri,sans-serif"><span style="color:#00000a">પરિણામ:&nbsp;</span></span></span></strong><span style="font-size:14px"><span style="font-family:Calibri,sans-serif"><span style="color:#00000a">' + data.resultGujarati + '</span></span></span></p>';
